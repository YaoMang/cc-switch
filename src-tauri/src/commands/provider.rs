...
#[tauri::command]
pub fn discover_opencode_provider_keys(
) -> Result<crate::opencode_discovery::ProviderKeyDiscoveryResult, String> {
    crate::opencode_discovery::discover_opencode_provider_keys().map_err(|e| e.to_string())
}
